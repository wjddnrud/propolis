								...
								<section>
									<div class="table-wrapper">
										...
										<center style="margin-left: 12%;">
											...
											<a href="board.html" class="button"><i class="fa-solid fa-arrow-left"></i>&nbsp;back</a>
											<a href="boardNotify.html" class="button" style="background-color: rgb(255, 0, 0); color: white; float: right;">🚨신고</a>
										</center>
									</div>
								</section>
<!-- 
